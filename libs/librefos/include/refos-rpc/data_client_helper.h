...
{
    int errnoRetVal = REFOS_EINVALID;
    data_mapping_t d;
    ...
    if (errnoRetVal != REFOS_ESUCCESS || d.dataspace == 0) {
                  ...
                  uint32_t contentSize, data_mapping_t* paramBuffer)
{
    ...
    if (!paramBuffer || paramBuffer->err != REFOS_ESUCCESS) {
